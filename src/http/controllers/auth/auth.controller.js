...
module.exports = {
    login: async (req, res) => {
      ...
      res.render("auth/login", {layout: 'layouts/auth.layout.ejs', error, success});
    },
    ...
    handleForgotPassword: async (req, res) => {
      ...
      const info = await transporter.sendMail({
        ...
        html: '<p>Click vào <a href="http://localhost:3000/auth/verify/' + token + '">link</a> để đặt lại mật khẩu</p>'
    ...
    handleRecoverPassword: async(req, res) => {
      ...
      await User.update({password: hashPassword},{where: {id: user.userId}})
