...
module.exports = {
  ...
  account: async (req, res) => {
    ...
    res.render("teacher/account/index", {req, userConnect, error, success, routerRoleRequest, user} )
  },  
  ...
  changePassword: async (req, res) => {
    const success = req.flash("success")
    const error = req.flash("error")
    res.render("teacher/account/change-password", {req, routerRoleRequest, error, success})
  },
  ...
  changePassword: async (req, res) => {
    const success = req.flash("success")
    const error = req.flash("error")
    res.render("students/account/change-password", {req, routerRoleRequest, error, success})
  },
  handleChangePassword: async (req, res) => {
    let password = req.user.password
    const {id} = req.user
  ...
  resetPassword: (req, res) => {
    const success = req.flash("success")
    const error = req.flash("error")
    res.render("teacher/account/reset-password", {req, routerRoleRequest, error, success})
  },
